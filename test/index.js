		...
		"No data": function () {
			...
			return {
				"": function (a) {
					...
					a(_("foo"), "foo", "Regular");
					a.deep(
						result = _("foo ${bar} data ${melo} ${bar}", {
							bar: "misa",
							melo: "orer"
						}),
				...
				"N": {
					"": function (a) {
						...
						a.deep(
							_("sin ${foo}", "plu ${foo}", 1, { foo: "bar" }),
							["sin ", "bar", ""],
							"Inserts: Singular"
						);
						a.deep(
							_("sin ${foo}", "plu ${foo}", 2, { foo: "bar" }),
							["plu ", "bar", ""],
							"Inserts: Plural"
						);
					},
					"Context": function (a) {
						...
						a.deep(
							_.call("bar", "sin ${foo}", "plu ${foo}", 1, { foo: "bar" }),
							["sin ", "bar", ""],
							"Inserts: Singular"
						);
						a.deep(
							_.call("bar", "sin ${foo}", "plu ${foo}", 2, { foo: "bar" }),
							["plu ", "bar", ""],
							"Inserts: Plural"
						);
					}
				...
				"Context": function (a) {
					...
					a.deep(
						result = _.call("bar", "foo ${bar} data ${melo} ${bar}", {
							bar: "misa",
							melo: "orer"
						}),
						["foo ", "misa", " data ", "orer", " ", "misa", ""]
		...
		"Locale": function () {
			...
			return {
				...
				"Context": function (a) {
					...
					a.deep(
						_.call("bar", "foo ${bar} data ${melo} ${bar}", {
							bar: "misa",
							melo: "orer"
						}),
						["marek ", "orer", " sd ", "misa", ""],
